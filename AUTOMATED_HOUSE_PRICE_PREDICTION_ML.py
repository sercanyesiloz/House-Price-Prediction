...
def hyperparameter_optimization(x, y, cv=10, scoring="neg_mean_squared_error"):
    ...
    models = [('LightGBM', LGBMRegressor(), best_params)]
...
def main(base, dump, scoring):
    ...
    with timer("Data Preprocessing"):
        train = pd.read_csv(r"C:\Users\casper\PycharmProjects\DSMLBC_5_Bootcamp\HAFTA_09\house_prices\train.csv")
        test = pd.read_csv(r"C:\Users\casper\PycharmProjects\DSMLBC_5_Bootcamp\HAFTA_09\house_prices\test.csv")
